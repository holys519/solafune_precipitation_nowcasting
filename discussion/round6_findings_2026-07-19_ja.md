...
| bihar/dhakaの異常な乾燥 (shafimiakhil) | 2023-2026全期間でbiharがmean 0.00066mm・p99=0.00 | 我々のfold4にもbihar/dhakaが含まれる(E-4のlocation_anatomy参照) | 既存のl_eda EDAで同様の統計を再確認し、他チームの指摘と付き合わせる価値あり |
