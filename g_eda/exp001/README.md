# g_eda exp001: Image-Processing EDA
...
| Path | Description |
| --- | --- |
| `../../outputs/g_eda/exp001/EDA_IMAGE_REPORT.md` | 要約レポート |
| `../../outputs/g_eda/exp001/*.csv` | 各解析の表 |
| `../../outputs/g_eda/exp001/figures/*.png` | 分布図と代表例 |
