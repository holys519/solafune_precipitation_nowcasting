...
- (a) no smoothing:                        0.58493
- (b) exp046 shipped (untuned, 0.85/0.15/0.0): 0.58536 (delta vs a: +0.00042)
- (c) 2-tap OOF-tuned (center=0.99, prev=0.01): 0.58493 (delta vs b: -0.00043)
- (d) 3-tap OOF-tuned (center=0.95, prev=0.00, prev2=0.05): 0.58489 (delta vs c: -0.00004) -> ADOPTED
- (e) + joint blur/threshold re-opt (sigma=0.0, thresholds={'goes': 0.0, 'himawari': 0.12, 'meteosat': 0.12}): 0.58418 (delta vs d: -0.00072)

Per-satellite (final stack e): goes=0.78858, himawari=0.72297, meteosat=0.35594

**Total delta (a -> e): -0.00076**
**Delta vs exp046 shipped (b -> e): -0.00118**
...
```json
{
  ...
  "oof_scores": {
    "no_smoothing": 0.5849342942237854,
    "exp046_shipped_baseline": 0.5853558778762817,
    "tuned_2tap": 0.5849305391311646,
    "tuned_3tap": 0.5848910212516785,
    "final_with_joint_postprocess": 0.5841758251190186
  },
  "used_3tap": true
}
```
