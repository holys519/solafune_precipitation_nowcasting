#!/bin/bash
# exp003 end-to-end entrypoint (no Slurm; run directly on a GPU box).
#
# Usage:
...
run_inference() {
  local model_dir="$PROJECT_DIR/g_model/exp003"
  local calibration_path="$PROJECT_DIR/outputs/analysis/exp003/oof_calibration.json"
  shopt -s nullglob
