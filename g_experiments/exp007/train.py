#!/usr/bin/env python3
"""Train helper copied for exp007; exp007 normally uses ensemble inference, not training."""
...
def main() -> None:
    ...
    print(
        f"exp007 GPU train fold={fold}/{n_splits} architecture={config['model'].get('architecture')} "
