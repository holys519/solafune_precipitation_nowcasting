#!/usr/bin/env python3
"""Train exp008: two-head rain detection + amount regression."""
...
def main() -> None:
    ...
    analysis_dir = resolve_path(config["paths"].get("analysis_dir", "../../outputs/analysis/exp008"))
    ...
    print(
        f"exp008 GPU train fold={fold}/{n_splits} architecture={config['model'].get('architecture')} "
