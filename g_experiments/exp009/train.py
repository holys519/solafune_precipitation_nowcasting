#!/usr/bin/env python3
"""Train exp009: two-head rain detection + amount regression."""
...
def main() -> None:
    ...
    analysis_dir = resolve_path(config["paths"].get("analysis_dir", "../../outputs/analysis/exp009"))
    ...
    print(
        f"exp009 GPU train fold={fold}/{n_splits} architecture={config['model'].get('architecture')} "
