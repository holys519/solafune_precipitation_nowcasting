#!/usr/bin/env python3
"""Train exp010: two-head rain detection + amount regression."""
...
def main() -> None:
    ...
    analysis_dir = resolve_path(config["paths"].get("analysis_dir", "../../outputs/analysis/exp010"))
    ...
    train_ds = PrecipDataset(
        ...
        has_target=True,
        data_quality=config["data"].get("data_quality", {}),
    ...
    print(
        f"exp010 GPU train fold={fold}/{n_splits} architecture={config['model'].get('architecture')} "
