#!/bin/bash
# exp012 end-to-end entrypoint (no Slurm; run directly on a GPU box).
#
# Usage:
...
run_inference() {
  local model_dir="$PROJECT_DIR/g_model/exp012"
  local calibration_path="$PROJECT_DIR/outputs/analysis/exp012/oof_calibration.json"
  shopt -s nullglob
