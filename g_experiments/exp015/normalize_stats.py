#!/usr/bin/env python3
"""Compute per-satellite, per-band normalization stats (copied from exp009; unused in exp015 --
norm_stats.json was copied verbatim from exp009 so it matches the reused checkpoints exactly;
kept only for self-containment / reference).
