#!/usr/bin/env python3
"""Train exp015: not normally used (this experiment reuses exp009 checkpoints); kept for self-containment."""
...
def main() -> None:
    ...
    print(
        f"exp015 GPU train fold={fold}/{n_splits} architecture={config['model'].get('architecture')} "
