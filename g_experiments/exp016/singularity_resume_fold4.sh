...
#SBATCH --time=720
#SBATCH --output=slurm-exp016-resume-fold4-%j.out
#SBATCH --error=slurm-exp016-resume-fold4-%j.err

# Resume exp016 after a timeout: train fold 4, then create OOF analysis,
