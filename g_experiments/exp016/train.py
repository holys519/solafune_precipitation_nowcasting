#!/usr/bin/env python3
"""Train exp016: hurdle log-normal head (G-030) on exp009-style successor-row inputs."""
...
def main() -> None:
    ...
    print(
        f"exp016 GPU train fold={fold}/{n_splits} architecture={config['model'].get('architecture')} "
