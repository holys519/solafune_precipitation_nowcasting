"""PyTorch datasets for exp017: exp009's successor-row pipeline + wavelength-aligned canonical
bands and uint8-domain physics channels (ticket G-031, doc/discussion_insights.md section 3).
