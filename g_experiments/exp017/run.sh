#!/bin/bash
# exp017 end-to-end entrypoint (no Slurm; run directly on a GPU box).
#
# Usage:
...
run_inference() {
  local model_dir="$PROJECT_DIR/g_model/exp017"
  local calibration_path="$PROJECT_DIR/outputs/analysis/exp017/oof_calibration.json"
  shopt -s nullglob
