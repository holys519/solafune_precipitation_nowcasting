#!/usr/bin/env python3
"""Train exp017: wavelength-aligned bands + physics channels (G-031), two-head control head."""
...
def main() -> None:
    ...
    print(
        f"exp017 GPU train fold={fold}/{n_splits} architecture={config['model'].get('architecture')} "
