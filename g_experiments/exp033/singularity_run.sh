...
#SBATCH --time=180
#SBATCH --no-requeue
#SBATCH --output=slurm-exp033-%j.out
#SBATCH --error=slurm-exp033-%j.err
# exp033: CPU-only blend ladder and optional exp014 overlap patch.
