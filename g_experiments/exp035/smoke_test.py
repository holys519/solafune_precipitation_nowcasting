#!/usr/bin/env python3
"""exp035 smoke test: config/channel consistency, CPU forward/backward for every arm, and a
...
ARMS = ["config.yaml", "config_no_dilation.yaml", "config_dilation_only.yaml", "config_tilemean.yaml"]
...
def main() -> None:
    for arm in ARMS:
        ...
        print(result)
    check_real_batch()
    print("exp035 smoke test PASSED")
