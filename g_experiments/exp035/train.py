#!/usr/bin/env python3
"""Train exp035: exp018's high-res localization net + exp028 temporal input design + exp030
...
def main() -> None:
    ...
    print(
        f"exp035 GPU train fold={fold}/{n_splits} architecture={config['model'].get('architecture')} "
