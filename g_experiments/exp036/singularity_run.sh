...
#SBATCH --time=180
#SBATCH --no-requeue
#SBATCH --output=slurm-exp036-%j.out
#SBATCH --error=slurm-exp036-%j.err
# exp036: OOF-weighted blend (g_eda/exp003 weights) and optional exp014 overlap patch.
