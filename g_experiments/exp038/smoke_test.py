#!/usr/bin/env python3
"""exp038 smoke test: config/channel consistency, CPU forward/backward for every arm, and a
...
ARMS = ["config.yaml", "config_features.yaml"]
...
def main() -> None:
    for arm in ARMS:
        ...
        print(result)
    check_real_batch()
    print("exp038 smoke test PASSED")
