...
#SBATCH --time=180
#SBATCH --no-requeue
#SBATCH --output=slurm-exp039-%j.out
#SBATCH --error=slurm-exp039-%j.err
# exp039: CPU-only blend ladder and optional exp014 overlap patch.
