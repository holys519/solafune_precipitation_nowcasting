...
#SBATCH --time=180
#SBATCH --no-requeue
#SBATCH --output=slurm-exp042-%j.out
#SBATCH --error=slurm-exp042-%j.err
# exp042: CPU-only blend ladder and optional exp014 overlap patch.
