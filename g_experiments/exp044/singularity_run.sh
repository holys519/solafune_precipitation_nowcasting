...
#SBATCH --time=180
#SBATCH --no-requeue
#SBATCH --output=slurm-exp044-%j.out
#SBATCH --error=slurm-exp044-%j.err
# exp044: CPU-only blend ladder and optional exp014 overlap patch.
