"""Model architectures for exp047: exp018's high-resolution hurdle log-normal U-Net plus an
optional dilated bottleneck ported from exp030 (`model.bottleneck_dilations`).
