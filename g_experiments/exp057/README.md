# exp057: Strict-Green Baseline 再構築 (survey v3 Phase 0-4)
...
| --- | --- | --- | ---: | --- |
| `config.yaml` | **green** | 配布バンドそのまま (16ch×3フレーム+mask+sat) | 54 | `g_model/exp057` |
| `config_features.yaml` | amber | +波長整列/物理特徴 (外部仕様由来の対応表を使うため運営確認まで amber) | 84 | `g_model/exp057_features` |
...
```bash
cd /group/project143/yamamoto/solafune_precipitation_nowcasting/g_experiments/exp057
