...
#SBATCH --job-name=exp064-smoke-swin
#SBATCH --output=slurm-exp064-smoke-swin-%j.out
#SBATCH --error=slurm-exp064-smoke-swin-%j.err
...
try:
    print('PASS', st.check_arm('config_swin.yaml'))
except Exception as e:
    import traceback; traceback.print_exc(); print('FAIL', type(e).__name__, str(e)[:200])
PY
"
